...
void leader_end_user(void) {
    if (leader_sequence_two_keys(KC_AT, KC_AT)) {
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_Z,       KC_X,       KC_C,       KC_D,       KC_V,    KC_K,    KC_H,       KC_COMM,    KC_DOT,     KC_SLSH,
                                LT(_SYM,KC_ESC), SC_SENT,    KC_SPC,  LT(_NAV,KC_BSPC)
    ),
    ...
    QK_LEAD, KC_LBRC, KC_LCBR, KC_RCBR, _______,             KC_CIRC, KC_LPRN, KC_RPRN, KC_RBRC, KC_TILD,
    ...
    _______, KC_F1,   KC_F2,   KC_F3,   KC_F10,              KC_VOLU, DT_PRNT,   DT_UP, DT_DOWN, QK_BOOT,
